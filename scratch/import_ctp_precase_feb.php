<?php
// Importer for CTP Pre Case Excel file for February 2026 (ctp_precase_feb.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Pre Case Import for February 2026 (ctp_precase_feb.xlsx)...\n";

$file = __DIR__ . '/../ctp_precase_feb.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_precase_feb.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PRE CASE FEBRUARY 2026 IMPORT COMPLETE SUMMARY:\n";
