<?php
// Importer for CTP PU Case Excel file for March 2026 (ctp_pucase_mar.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Case Import for March 2026 (ctp_pucase_mar.xlsx)...\n";

$file = __DIR__ . '/../ctp_pucase_mar.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_pucase_mar.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PU CASE MARCH 2026 IMPORT COMPLETE SUMMARY:\n";
