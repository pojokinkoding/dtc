...
$sh = $sheets[0];
$sheetXml = $zip->getFromName('xl/' . $targetMap[$sh['rId']]);
...
echo "Parsed Specs Map from Top Table:\n";
echo json_encode($specsByModel, JSON_PRETTY_PRINT) . "\n";
?>
