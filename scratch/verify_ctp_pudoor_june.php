...
echo "================ VERIFYING CTP PU DOOR JUNE 2026 IMPORT ================\n";
...
$stmt2 = $conn->query("
    ...
    WHERE p.target_month = '2026-06' AND p.data_type = 'CTP' AND p.line_name = 'REF 01' AND p.section_name = 'PU Door'
");
...
echo "TOTAL CTP PU DOOR JUNE SESSIONS: $total_s | TOTAL CTP PU DOOR JUNE MEASUREMENTS: $total_m\n";
