<?php
// Importer for CTP Pre Case Excel file for June 2026 (ctp_precase_jun.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Pre Case Import for June 2026 (ctp_precase_jun.xlsx)...\n";

$file = __DIR__ . '/../ctp_precase_jun.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_precase_jun.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PRE CASE JUNE 2026 IMPORT COMPLETE SUMMARY:\n";
