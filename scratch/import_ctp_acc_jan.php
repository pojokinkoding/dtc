<?php
// Importer for CTP Accessories Excel file for January 2026 (ctp_acc_jan.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Accessories Import for January 2026 (ctp_acc_jan.xlsx)...\n";

$file = __DIR__ . '/../ctp_acc_jan.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_acc_jan.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP ACCESSORIES JANUARY 2026 IMPORT COMPLETE SUMMARY:\n";
