<?php
// Importer for CTP Accessories Excel file for June 2026 (ctp_acc_jun.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Accessories Import for June 2026 (ctp_acc_jun.xlsx)...\n";

$file = __DIR__ . '/../ctp_acc_jun.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_acc_jun.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP ACCESSORIES JUNE 2026 IMPORT COMPLETE SUMMARY:\n";
