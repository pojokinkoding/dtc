<?php
// Importer for CTP Accessories Excel file for May 2026 (ctp_acc_may.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Accessories Import for May 2026 (ctp_acc_may.xlsx)...\n";

$file = __DIR__ . '/../ctp_acc_may.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_acc_may.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP ACCESSORIES MAY 2026 IMPORT COMPLETE SUMMARY:\n";
