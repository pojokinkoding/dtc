<?php
// Importer for CTP PU Door Excel file for April 2026 (ctp_pudoor_apr.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Door Import for April 2026 (ctp_pudoor_apr.xlsx)...\n";

$file = __DIR__ . '/../ctp_pudoor_apr.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_pudoor_apr.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PU DOOR APRIL 2026 IMPORT COMPLETE SUMMARY:\n";
