<?php
// Importer for CTP Accessories Excel file for April 2026 (ctp_acc_apr.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Accessories Import for April 2026 (ctp_acc_apr.xlsx)...\n";

$file = __DIR__ . '/../ctp_acc_apr.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_acc_apr.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP ACCESSORIES APRIL 2026 IMPORT COMPLETE SUMMARY:\n";
