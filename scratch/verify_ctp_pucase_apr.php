...
echo "================ VERIFYING CTP PU CASE APR 2026 IMPORT ================\n";

// 1. Check Master Parameters for CTP Apr 2026
echo "\n--- Master Parameters (dtc_master_parameters) for Apr 2026 & CTP ---\n";
$stmt2 = $conn->query("
    ...
    WHERE p.target_month = '2026-04' AND p.data_type = 'CTP' AND p.line_name = 'REF 01' AND p.section_name = 'PU Case'
");
...
// 2. Session & Measurement Counts per Parameter for CTP Apr 2026
echo "\n--- Sessions & Measurements Breakdown (CTP Apr 2026) ---\n";
$total_s = 0;
$total_m = 0;
foreach ($params as $pr) {
    $pid = $pr['parameter_id'];
...
echo "\nTOTAL CTP APR SESSIONS: $total_s | TOTAL CTP APR MEASUREMENTS: $total_m\n";
