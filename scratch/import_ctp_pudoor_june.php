<?php
// Importer for CTP PU Door Excel file for June 2026 (ctp_pudoor_jun.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Door Import for June 2026 (ctp_pudoor_jun.xlsx)...\n";

$file = __DIR__ . '/../ctp_pudoor_jun.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_pudoor_jun.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PU DOOR JUNE 2026 IMPORT COMPLETE SUMMARY:\n";
