<?php
// Importer for CTP Pre Case Excel file for March 2026 (ctp_precase_mar.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Pre Case Import for March 2026 (ctp_precase_mar.xlsx)...\n";

$file = __DIR__ . '/../ctp_precase_mar.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_precase_mar.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PRE CASE MARCH 2026 IMPORT COMPLETE SUMMARY:\n";
