<?php
// Importer for CTP Accessories Excel file for February 2026 (ctp_acc_feb.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Accessories Import for February 2026 (ctp_acc_feb.xlsx)...\n";

$file = __DIR__ . '/../ctp_acc_feb.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_acc_feb.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP ACCESSORIES FEBRUARY 2026 IMPORT COMPLETE SUMMARY:\n";
