<?php
// Importer for CTP Pre Case Excel file for January 2026 (ctp_precase_jan.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Pre Case Import for January 2026 (ctp_precase_jan.xlsx)...\n";

$file = __DIR__ . '/../ctp_precase_jan.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_precase_jan.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PRE CASE JANUARY 2026 IMPORT COMPLETE SUMMARY:\n";
