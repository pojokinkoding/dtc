<?php
// Importer for CTP PU Door Excel file for February 2026 (ctp_pudoor_feb.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Door Import for February 2026 (ctp_pudoor_feb.xlsx)...\n";

$file = __DIR__ . '/../ctp_pudoor_feb.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_pudoor_feb.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PU DOOR FEBRUARY 2026 IMPORT COMPLETE SUMMARY:\n";
