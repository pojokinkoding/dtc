<?php
// Importer for CTP PU Door Excel file for January 2026 (ctp_pudoor_jan.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Door Import for January 2026 (ctp_pudoor_jan.xlsx)...\n";

$file = __DIR__ . '/../ctp_pudoor_jan.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_pudoor_jan.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PU DOOR JANUARY 2026 IMPORT COMPLETE SUMMARY:\n";
