<?php
// Importer for CTP PU Case Excel file for January 2026 (ctp_pucase_jan.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Case Import for January 2026 (ctp_pucase_jan.xlsx)...\n";
...
for ($idx = 4; $idx < count($sheets); $idx++) {
    ...
    // 2. Find or Insert Parameter in dtc_master_parameters for target_month = '2026-01'
    ...
    if (!$parameter_id) {
        ...
        echo "Created NEW Parameter ID: $parameter_id for Jan 2026\n";
    } else {
        echo "Found existing Parameter ID: $parameter_id for Jan 2026\n";
    }

    // 3. Ensure running model entry in dtc_running_models for target_month = '2026-01'
...
echo "\n====================================================\n";
echo "CTP PU CASE JANUARY 2026 IMPORT COMPLETE SUMMARY:\n";
