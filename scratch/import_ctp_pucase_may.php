<?php
// Importer for CTP PU Case Excel file for May 2026 (ctp_pucase_may.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Case Import for May 2026 (ctp_pucase_may.xlsx)...\n";

$file = __DIR__ . '/../ctp_pucase_may.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_pucase_may.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PU CASE MAY 2026 IMPORT COMPLETE SUMMARY:\n";
