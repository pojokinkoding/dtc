...
echo "================ VERIFYING CTP PU DOOR MAR 2026 IMPORT ================\n";
...
$stmt2 = $conn->query("
    ...
    WHERE p.target_month = '2026-03' AND p.data_type = 'CTP' AND p.line_name = 'REF 01' AND p.section_name = 'PU Door'
");
...
echo "TOTAL CTP PU DOOR MAR SESSIONS: $total_s | TOTAL CTP PU DOOR MAR MEASUREMENTS: $total_m\n";
