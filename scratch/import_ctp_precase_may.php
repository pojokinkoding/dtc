<?php
// Importer for CTP Pre Case Excel file for May 2026 (ctp_precase_may.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP Pre Case Import for May 2026 (ctp_precase_may.xlsx)...\n";

$file = __DIR__ . '/../ctp_precase_may.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_precase_may.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PRE CASE MAY 2026 IMPORT COMPLETE SUMMARY:\n";
