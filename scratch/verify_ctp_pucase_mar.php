...
echo "================ VERIFYING CTP PU CASE MAR 2026 IMPORT ================\n";

// 1. Check Master Parameters for CTP Mar 2026
echo "\n--- Master Parameters (dtc_master_parameters) for Mar 2026 & CTP ---\n";
$stmt2 = $conn->query("
    ...
    WHERE p.target_month = '2026-03' AND p.data_type = 'CTP' AND p.line_name = 'REF 01' AND p.section_name = 'PU Case'
");
...
// 2. Session & Measurement Counts per Parameter for CTP Mar 2026
echo "\n--- Sessions & Measurements Breakdown (CTP Mar 2026) ---\n";
$total_s = 0;
$total_m = 0;
foreach ($params as $pr) {
    $pid = $pr['parameter_id'];
...
echo "\nTOTAL CTP MAR SESSIONS: $total_s | TOTAL CTP MAR MEASUREMENTS: $total_m\n";
