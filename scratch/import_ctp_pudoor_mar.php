<?php
// Importer for CTP PU Door Excel file for March 2026 (ctp_pudoor_mar.xlsx)
require_once __DIR__ . '/../config/config.php';

echo "Starting CTP PU Door Import for March 2026 (ctp_pudoor_mar.xlsx)...\n";

$file = __DIR__ . '/../ctp_pudoor_mar.xlsx';
if (!file_exists($file)) {
    die("Error: File ctp_pudoor_mar.xlsx not found.\n");
}
...
echo "\n====================================================\n";
echo "CTP PU DOOR MARCH 2026 IMPORT COMPLETE SUMMARY:\n";
